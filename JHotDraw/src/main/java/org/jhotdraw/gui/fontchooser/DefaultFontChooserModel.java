...
public class DefaultFontChooserModel extends AbstractFontChooserModel {
    ...
    public void setFonts(Font[] fonts) {
        ...
        serifFontsAdd(root, labels, families);

        sansSerifAdd(root, labels, families);

        scriptsAdd(root, labels, families);
        ...
        root.add(
                new FontCollectionNode(labels.getString("FontCollection.monospaced"), collectFamiliesNamed(families,
                        ...
                        "Miriam Fixed",
                        "Rod")));
        derocativeAdd(root, labels, families);
    ...
    public void serifFontsAdd(DefaultMutableTreeNode root, ResourceBundleUtil labels, ArrayList<FontFamilyNode> families) {
        // Serif fonts
        root.add(
    ...
    public void sansSerifAdd(DefaultMutableTreeNode root, ResourceBundleUtil labels, ArrayList<FontFamilyNode> families) {
// Sans Serif
        root.add(
    ...
    public void scriptsAdd(DefaultMutableTreeNode root, ResourceBundleUtil labels, ArrayList<FontFamilyNode> families) {
        // Scripts
        root.add(
    ...
    public void derocativeAdd(DefaultMutableTreeNode root, ResourceBundleUtil labels, ArrayList<FontFamilyNode> families) {
        // Decorative
        root.add(
